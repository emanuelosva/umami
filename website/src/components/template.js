      ...
      <div className="barra-superior ">
          ...
          <nav>
            ...
            <div className="nav_options">
              <ul>
                ...
                <li><Link to="/carrito">Carrito<img src={carritoCompras} alt="" /></Link></li>
                <li><p style={{ color: 'black' }}>{this.props.clienteCarrito.carrito.length - 1}</p></li>
              </ul>
            </div>
          </nav>
        </div>
        ...
        <footer className="footer">
          ...
          <ul className="contenedor-creditos-footer">
            <li>Toda la informacion es tomada de: <br /><br /><a href="#">https://www.recetasnestle.com.mx/</a></li>
